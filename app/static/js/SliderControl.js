L.Control.SliderControl = L.Control.extend({
    ...
    initialize: function (options) {
        ...
        this._layer2 = this.options.layer2;
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px"><div id="testid" class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>');
	...
	console.log($(document));
        ...
        if (this._layer) {
            ...
            index_temp = 0;
            this._layer2.eachLayer(function (layer) {
                options.markers2[index_temp] = layer;
                ++index_temp;
            })
    ...
    startSlider: function () {
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.range){
                        ...
                        for (i = ui.value - _options.follow + 1; i <= ui.value ; i++) {
                            if(_options.markers[i]) {
                                console.log(_options.markers2[i]);
                                map.addLayer(_options.markers[i]);
        ...
        for (i = _options.minValue; i <= index_start; i++) {
            ...
            // console.log(_options.markers);
            _options.map.addLayer(_options.markers[15]);
        }
    }
});
